...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Ma+Shan+Zheng&family=Noto+Serif+TC:wght@400;700&family=ZCOOL+XiaoWei&family=ZCOOL+QingKe+HuangYou&display=swap" rel="stylesheet">
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        body {
            font-family: '標楷體', 'DFKai-SB', 'Noto Serif TC', 'ZCOOL XiaoWei', 'Times New Roman', serif;
            background: url('山水畫.jpg') no-repeat center center fixed;
        ...
        .cloud-layer-1, .cloud-layer-2, .cloud-layer-3,
        .cloud-layer-4, .cloud-layer-5, .cloud-layer-6, .water {
            display: none;
        }
        ...
        .mountain-far::before {
            ...
            width: 55%;
            height: 100%;
            background: radial-gradient(ellipse 100% 80% at 50% 100%, #3a3a3a 0%, transparent 70%);
        }
        ...
        .mountain-far::after {
            ...
            width: 65%;
            height: 120%;
            background: radial-gradient(ellipse 100% 75% at 50% 100%, #4a4a4a 0%, transparent 65%);
        }
        ...
        .mountain-mid::before {
            ...
            width: 45%;
            height: 100%;
            background: radial-gradient(ellipse 100% 85% at 50% 100%, #2d2d2d 0%, transparent 60%);
        }
        ...
        .mountain-mid::after {
            ...
            width: 50%;
            height: 85%;
            background: radial-gradient(ellipse 100% 80% at 50% 100%, #3d3d3d 0%, transparent 55%);
        }
        ...
        .mountain-near::before {
            ...
            width: 42%;
            height: 100%;
            background: radial-gradient(ellipse 100% 90% at 50% 100%, #1a1a1a 0%, transparent 55%);
        }
        ...
        .mountain-near::after {
            ...
            width: 48%;
            height: 80%;
            background: radial-gradient(ellipse 100% 85% at 50% 100%, #252525 0%, transparent 50%);
        }
        ...
        .cloud-layer-1 {
            ...
            height: 100px;
            background: 
                radial-gradient(ellipse 180px 50px at 5% 50%, rgba(60,60,60,0.3) 0%, transparent 70%),
                radial-gradient(ellipse 220px 60px at 25% 60%, rgba(50,50,50,0.25) 0%, transparent 70%),
                radial-gradient(ellipse 200px 55px at 45% 40%, rgba(55,55,55,0.28) 0%, transparent 70%),
                radial-gradient(ellipse 190px 50px at 65% 55%, rgba(45,45,45,0.25) 0%, transparent 70%),
                radial-gradient(ellipse 240px 65px at 85% 45%, rgba(50,50,50,0.3) 0%, transparent 70%);
            z-index: -2;
        ...
        .cloud-layer-2 {
            ...
            height: 90px;
            background: 
                radial-gradient(ellipse 200px 55px at 10% 50%, rgba(80,80,80,0.22) 0%, transparent 70%),
                radial-gradient(ellipse 170px 50px at 35% 45%, rgba(70,70,70,0.2) 0%, transparent 70%),
                radial-gradient(ellipse 230px 60px at 60% 55%, rgba(75,75,75,0.22) 0%, transparent 70%),
                radial-gradient(ellipse 190px 52px at 82% 50%, rgba(65,65,65,0.2) 0%, transparent 70%);
            z-index: -2;
        ...
        .cloud-layer-3 {
            ...
            height: 80px;
            background: 
                radial-gradient(ellipse 260px 45px at 15% 50%, rgba(90,90,90,0.25) 0%, transparent 70%),
                radial-gradient(ellipse 220px 40px at 45% 55%, rgba(85,85,85,0.22) 0%, transparent 70%),
                radial-gradient(ellipse 280px 50px at 75% 45%, rgba(80,80,80,0.25) 0%, transparent 70%);
            z-index: -2;
        ...
        .cloud-layer-4 {
            ...
            height: 70px;
            background: 
                radial-gradient(ellipse 300px 40px at 8% 50%, rgba(100,100,100,0.2) 0%, transparent 70%),
                radial-gradient(ellipse 250px 35px at 38% 45%, rgba(95,95,95,0.18) 0%, transparent 70%),
                radial-gradient(ellipse 280px 42px at 68% 55%, rgba(90,90,90,0.2) 0%, transparent 70%),
                radial-gradient(ellipse 260px 38px at 92% 50%, rgba(85,85,85,0.18) 0%, transparent 70%);
            z-index: -2;
        ...
        .cloud-layer-5 {
            ...
            height: 60px;
            background: 
                radial-gradient(ellipse 320px 35px at 12% 50%, rgba(110,110,110,0.3) 0%, transparent 70%),
                radial-gradient(ellipse 280px 32px at 42% 55%, rgba(105,105,105,0.28) 0%, transparent 70%),
                radial-gradient(ellipse 300px 38px at 72% 45%, rgba(100,100,100,0.3) 0%, transparent 70%);
            z-index: -2;
        ...
        .cloud-layer-6 {
            ...
            height: 50px;
            background: 
                radial-gradient(ellipse 350px 30px at 5% 50%, rgba(120,120,120,0.25) 0%, transparent 70%),
                radial-gradient(ellipse 300px 28px at 30% 45%, rgba(115,115,115,0.22) 0%, transparent 70%),
                radial-gradient(ellipse 380px 32px at 55% 55%, rgba(110,110,110,0.25) 0%, transparent 70%),
                radial-gradient(ellipse 320px 28px at 80% 50%, rgba(105,105,105,0.22) 0%, transparent 70%);
            z-index: -2;
            animation: cloud-drift-reverse 75s linear infinite;
            animation-delay: -10s;
        }
        ...
        .water {
            ...
            background: linear-gradient(180deg, 
                rgba(180,175,165,0.6) 0%,
                rgba(160,155,145,0.7) 50%,
                rgba(140,135,125,0.8) 100%);
            z-index: -3;
        }
        ...
        @keyframes water-ripple {
            ...
            50% { transform: translateX(15px) scaleY(1.02); opacity: 0.8; }
        }
        ...
        .bird:nth-child(1) { top: 0; left: 0; animation-delay: 0s; }
        .bird:nth-child(2) { top: 15px; left: 25px; animation-delay: 0.1s; font-size: 10px; }
        .bird:nth-child(3) { top: 5px; left: 50px; animation-delay: 0.2s; }
        .bird:nth-child(4) { top: 20px; left: 70px; animation-delay: 0.15s; font-size: 11px; }
        .bird:nth-child(5) { top: -5px; left: 90px; animation-delay: 0.25s; font-size: 9px; }

        @keyframes birds-fly {
            0% { transform: translate(-10%, 0); }
            100% { transform: translate(110vw, -10%); }
        }
...
<body>
    ...
    <script>
        ...
        async function joinRoom() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    // 將鳥移到遊戲容器下層
                    document.querySelector('.birds').style.zIndex = '-1';
        ...
        async function leaveRoom() {
            ...
            // 將鳥恢復到上層
            document.querySelector('.birds').style.zIndex = '100';
        }
        ...
        function clearEffects() {
            ...
            // 清除煙火的定時器和元素
            if (fireworks) {
                if (fireworks.dataset.intervalId) {
                    clearInterval(parseInt(fireworks.dataset.intervalId));
                }
                fireworks.remove();
            }
            ...
            // 清除傷心特效的定時器和元素
            if (sad) {
                if (sad.dataset.intervalId) {
                    clearInterval(parseInt(sad.dataset.intervalId));
                }
                sad.remove();
            }
